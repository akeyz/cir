...
$config['rest_default_format'] = 'json'; //修改接口数据格式为json
...
//$config['rest_auth'] = 'digest'; //修改REST服务验证模式为digest
...
//$config['auth_source'] = 'library';//修改为自定义方法验证
...
$config['rest_enable_keys'] = TRUE; //启用key验证的模式
...
|
*/
$config['rest_logs_table'] = 'access_logs';

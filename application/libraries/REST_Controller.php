...
//        	if (isset($this->input->post(config_item('rest_key_name')))){
//        		$this->_args[config_item('rest_key_name')] = $this->input->post(config_item('rest_key_name'));
//        	}
    }
    ...
    protected function _check_access()
    {
        ...
        $this->rest->db->like('controller', $controller);
